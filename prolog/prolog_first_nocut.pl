...
find([], N, N).
find([E|_], I, I) :- E > 0.
find([E|T], N, I) :- E =< 0, I2 is I + 1, find(T, N, I2).
...
dropRight([E|T], N, [E|T2]) :- size(T, M), N < M , dropRight(T, N, T2).
