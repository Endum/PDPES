...
object FunctionsImpl extends Functions:
  ...
  private def combiner[T](a:Seq[T])(using comb:Combiner[T]): T = a.foldLeft(comb.unit)(comb.combine)
...
case class CombinerImpl[A](override val unit: A, override val combine(a:A,b:A): A) extends Combiner[A]
